# Getting help with `mipaquete`

Thank you for using `mipaquete`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/mipaquete`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/mipaquete),
...
[search issues and pull requests](https://github.com/JuliethLopez/mipaquete/issues)
